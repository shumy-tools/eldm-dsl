...
public class EldmDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Module___DefinitionsKeyword_4_0_BEGINTerminalRuleCall_4_1_ENDTerminalRuleCall_4_5__q;
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_Module___DefinitionsKeyword_4_0_BEGINTerminalRuleCall_4_1_ENDTerminalRuleCall_4_5__q.equals(syntax))
				emit_Module___DefinitionsKeyword_4_0_BEGINTerminalRuleCall_4_1_ENDTerminalRuleCall_4_5__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Module___DefinitionsKeyword_4_0_BEGINTerminalRuleCall_4_1_ENDTerminalRuleCall_4_5__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
